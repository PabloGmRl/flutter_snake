...
import 'dart:math';
import 'package:flutter_snake/snake_app.dart';
import 'package:flutter_snake/snake_pagina_principal.dart';
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                Text("Dev: Pablo", style: TextStyle(color: Colors.green),),
                SizedBox(height: 10,),
                Text("Tus muertos", style: TextStyle(color: Colors.blue),),
              ],
            ),
            actions: [
              Container(
